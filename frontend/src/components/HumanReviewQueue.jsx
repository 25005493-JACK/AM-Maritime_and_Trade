      ...
      <div className="p-4 border-b border-blue-900/60 bg-slate-950 flex items-center justify-between shrink-0 shadow-md">
        <div>
          <h2 className="text-base font-extrabold text-slate-100 flex items-center space-x-2">
            ...
            <span className="text-xs bg-amber-950 text-amber-300 font-mono px-2 py-0.5 rounded border border-amber-800 font-bold">
            ...
            return (
              ...
              >
                ...
                <div 
                  ...
                  className="p-4 bg-gradient-to-r from-slate-900 via-amber-950/20 to-slate-900 flex items-center justify-between cursor-pointer hover:bg-slate-800/80 transition"
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="flex items-center space-x-2">
                        <span className="font-mono text-xs text-amber-400 font-extrabold">{email.id}</span>
                      ...
                      <h3 className="text-sm font-semibold text-slate-100 mt-0.5 line-clamp-1">{email.subject}</h3>
                    </div>
                  </div>

                  <div className="flex items-center space-x-3">
                    <span className="px-2.5 py-1 rounded-lg text-xs font-mono font-bold bg-amber-950 text-amber-300 border border-amber-800 flex items-center space-x-1">
                      <HelpCircle className="w-3.5 h-3.5" />
                      <span>Reason: {primaryReason}</span>
                    </span>
                  ...
                  <div className="p-5 border-t border-amber-500/30 bg-slate-950 space-y-4 animate-fadeIn">
                    ...
                    <div className="p-4 rounded-xl bg-amber-950/30 border border-amber-500/30 space-y-2">
                      ...
                      <div className="text-[11px] font-mono text-amber-400 pt-1">
                        <strong>Triggered Reason Code:</strong> <code className="bg-slate-900 px-2 py-0.5 rounded border border-amber-900">{primaryReason}</code>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-slate-800">
                      ...
                      <button
                        ...
                        className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-amber-600 via-amber-500 to-yellow-500 hover:from-amber-500 hover:to-yellow-400 text-slate-950 font-extrabold text-xs flex items-center space-x-2 shadow-lg shadow-amber-950/60 transition active:scale-95"
                      >
